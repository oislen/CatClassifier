...
def commandline_interface():
    ...
    parser.add_argument("--device_type", dest="device_type", type=str, default=cons.device_type, choices=['cpu', 'cuda'], help="String, device type to run the model on, default is cuda if available otherwise cpu",)
    ...
    input_params_dict["device_type"] = args.device_type
