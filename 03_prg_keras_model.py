...
lenet5_arch = LeNet5(input_shape = cons.input_shape, n_classes = 2, output_activation = 'softmax', name = 'LeNet5')
...
history = lenet5_arch.fit_generator(train_generator, epochs=epochs, validation_data=validation_generator, validation_steps=total_validate//cons.batch_size, steps_per_epoch=total_train//cons.batch_size, callbacks=callbacks)
...
predict = lenet5_arch.predict(test_generator, steps=np.ceil(nb_samples/cons.batch_size))
